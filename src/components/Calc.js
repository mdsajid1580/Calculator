      ...
      return (
          <div className="button">
              <button name="(" onClick={e => this.props.onClick(e.target.name)}>(</button>
                ...
                <button name=")" onClick={e => this.props.onClick(e.target.name)}>)</button>
                <button class="orange" name="C" onClick={e => this.props.onClick(e.target.name)}>C</button><br/>
              ...
              <button class="green" name="=" onClick={e => this.props.onClick(e.target.name)}>=</button>
              <button class="orange" name="/" onClick={e => this.props.onClick(e.target.name)}>/</button><br/>
          </div>
      );
  }
